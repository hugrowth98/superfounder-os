...
# LinkedIn Writing Core - Fondation {{CREATOR_NAME}}

Ce skill est le socle de tout contenu LinkedIn produit pour {{CREATOR_FIRSTNAME}}. Il définit l'identité, la voix, les règles structurelles et les frameworks de décision. Tous les autres skills LinkedIn (storytelling, educational, lead-magnet, hot-take) héritent de ces règles.

> Ce skill a été personnalisé via l'installeur. Si les blocs ci-dessous contiennent encore des marqueurs `{{ ... }}`, lance le skill `linkedin-system-installer` pour les remplir.

## Qui est {{CREATOR_FIRSTNAME}}

{{POSITIONING}}

**Monopole personnel** : {{MONOPOLE}}

**Posture LinkedIn** : {{POSTURE}}

**ICP (clients)** : {{ICP}}
**IAP (audience large)** : {{IAP}}
...
### Ce que {{CREATOR_FIRSTNAME}} NE FAIT PAS
{{DONT_LIST}}
...
### Langue
{{CREATOR_FIRSTNAME}} écrit en **{{LANGUAGE}}**. Les termes techniques dans une autre langue sont acceptables quand ils sont naturels dans le métier, mais le post est toujours rédigé en {{LANGUAGE}}.

## Stratégie de contenu

### Répartition éditoriale ({{POSTING_FREQUENCY}})
{{CONTENT_MIX}}

### Authority-First Framework ({{AUTHORITY_MIX}})
...
La répartition exacte est définie par `{{AUTHORITY_MIX}}`.
...
5. **Ton {{CREATOR_FIRSTNAME}}** : direct, concret, sans jargon inutile. Ça doit sonner comme {{CREATOR_FIRSTNAME}} parle, pas comme un copywriter américain traduit.
...
- [ ] Le post sonne comme {{CREATOR_FIRSTNAME}}, pas comme un robot ou un coach LinkedIn générique
...
- [ ] Écrit en {{LANGUAGE}} avec termes techniques dans une autre langue seulement quand c'est naturel
...
- `references/creator-inspiration.md` - Posts des créateurs que tu admires (à remplir via l'installeur). Consulte ce fichier pour t'inspirer des structures et styles qui performent.
- `references/examples-myposts.md` - Tes posts réels analysés en profondeur (à remplir via l'installeur). C'est LA référence pour calibrer la voix et le ton. Consulte ce fichier en priorité.
