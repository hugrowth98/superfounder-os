...
Voir `Projects/Contenu/ressources/strategie-contenu.md`, section Créateurs admirés.
...
- `Projects/Contenu/ressources/swipe-file.md` -> les posts des créateurs admirés et tes posts likés
- `Projects/Contenu/ressources/posts-de-reference.md` -> tes propres posts, pour caler la voix
