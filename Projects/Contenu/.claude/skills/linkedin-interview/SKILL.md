...
1. **Le second cerveau, en premier** : `ABOUT.ME/` (déjà chargé), `Contexte/Offer-Positioning.md`, `Contexte/Clients-Problems-and-Messages.md`, `Contexte/Tone-and-Voice.md`, puis `Projects/Contenu/ressources/strategie-contenu.md` (convictions, piliers) et `posts-de-reference.md`. Dans Superfounder OS, c'est là que vit le positionnement : pas besoin de le chercher ailleurs.
...
4. **Banque existante** : `Projects/Contenu/ressources/banque-vecu.md`, créée par une session précédente de ce skill (voir Phase 4).
...
Un seul fichier : `Projects/Contenu/ressources/banque-vecu.md`, toutes les pépites, en append. Crée-le à la première session avec un en-tête qui explique le format.
