...
- `references/examples-educational.md` - Méta-analyse des facteurs de viralité éducative + emplacement de ton swipe file de posts éducatifs de référence (dans `Projects/Contenu/ressources/`).
- Consulte aussi `Projects/Contenu/ressources/posts-de-reference.md` pour tes posts éducatifs réels.
