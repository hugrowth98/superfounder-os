...
1. **Faites le jour 1 d'abord** ("Installe mon second cerveau" a la racine du workspace).
   La prospection lit votre offre, votre cible et votre voix dans `Contexte/` : elle ne vous
   les redemande pas.
2. **Ouvrez le dossier `Projects/Prospection/`** dans Claude Code. Verifiez que vous avez un
...
- Vous demander l'adresse de votre site web seulement si le jour 1 n'a pas ete fait.
