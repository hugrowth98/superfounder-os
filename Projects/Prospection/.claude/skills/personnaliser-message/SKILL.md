...
1. Lit `contexte.md` (sections 1 "Offre", 3 "Probleme resolu", 4 "Differenciation", 5 "Voix",
...
- **Voix du client, pas la voix par defaut de Claude.** Respecter scrupuleusement le ton, le
  tutoiement/vouvoiement et les mots a eviter definis en section 5 de `contexte.md`.
...
Relire `contexte.md`. Si la section 5 (voix) n'est pas remplie, demander a l'utilisateur de
