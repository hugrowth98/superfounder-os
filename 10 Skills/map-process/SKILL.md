---
name: map-process
description: Cartographier tous les process recurrents (perso et pro) par frequence, et reflechir a leur optimisation avec l'IA. Produit une cartographie dans 05 Departements/Strategie/.
user-invocable: true
context: main
---
...
- Identite : `01 About-Me/about-me.md` (+ `01 About-Me/my-company.md` si activite pro)
- Dossiers de travail : `06 Clients/`, `05 Departements/Contenu/`, `05 Departements/Vente/`, `05 Departements/Strategie/`
- Sortie : `05 Departements/Strategie/Cartographie-process.md`

## Avant de commencer
1. Lis `01 About-Me/about-me.md` (et `my-company.md`) pour comprendre l'activite de l'utilisateur.
...
Cree ou mets a jour `05 Departements/Strategie/Cartographie-process.md` :
