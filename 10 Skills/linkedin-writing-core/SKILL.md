...
> Ce skill ne contient aucune donnée sur le créateur : il lit le contexte à chaque exécution. Avant d'écrire, charge dans l'ordre `01 About-Me/` (déjà chargé), `02 Contexte/Tone-and-Voice.md`, `02 Contexte/Offer-Positioning.md`, `02 Contexte/Clients-Problems-and-Messages.md`, puis `05 Departements/Contenu/LinkedIn/strategie-contenu.md` et `posts-de-reference.md`. Si l'un d'eux contient encore `[à remplir]`, propose de lancer "Installe mon contenu".

## Qui est le créateur

Voir `02 Contexte/Offer-Positioning.md` et `05 Departements/Contenu/LinkedIn/strategie-contenu.md`, section Positionnement.

**Monopole personnel** : voir `05 Departements/Contenu/LinkedIn/strategie-contenu.md`

**Posture LinkedIn** : voir `05 Departements/Contenu/LinkedIn/strategie-contenu.md`

**ICP (clients)** : voir `02 Contexte/Clients-Problems-and-Messages.md`
**IAP (audience large)** : voir `05 Departements/Contenu/LinkedIn/strategie-contenu.md`, section Audiences

## Voix & ADN éditorial

### Ton
Voir `02 Contexte/Tone-and-Voice.md`, section Ton.

### Ce que le créateur NE FAIT PAS
Voir `02 Contexte/Tone-and-Voice.md` (ce qu'il ne dirait jamais) et `01 About-Me/anti-ai-voice.md`.

### Marqueurs de style
Voir `02 Contexte/Tone-and-Voice.md`, section Marqueurs de style, et `05 Departements/Contenu/LinkedIn/posts-de-reference.md`.

### Langue
Le créateur écrit dans la langue définie dans `02 Contexte/Tone-and-Voice.md`. Les termes techniques dans une autre langue sont acceptables quand ils sont naturels dans le métier, mais le post est toujours rédigé dans cette langue.

## Stratégie de contenu

### Répartition éditoriale (la fréquence de publication définie dans `05 Departements/Contenu/LinkedIn/strategie-contenu.md`)
Voir `05 Departements/Contenu/LinkedIn/strategie-contenu.md`, section Répartition éditoriale.

### Authority-First Framework (le mix autorité / perso / offre de `05 Departements/Contenu/LinkedIn/strategie-contenu.md`)
...
La répartition exacte est définie par `le mix autorité / perso / offre de `05 Departements/Contenu/LinkedIn/strategie-contenu.md``.

### Piliers thématiques
Voir `05 Departements/Contenu/LinkedIn/strategie-contenu.md`, section Piliers.
...
- [ ] Écrit en la langue définie dans `02 Contexte/Tone-and-Voice.md` avec termes techniques dans une autre langue seulement quand c'est naturel
...
- `05 Departements/Contenu/LinkedIn/swipe-file.md` : posts des créateurs admirés et posts likés. Pour s'inspirer des structures et styles qui performent.
- `05 Departements/Contenu/LinkedIn/posts-de-reference.md` : les posts réels du créateur analysés. C'est LA référence pour calibrer la voix et le ton. À consulter en priorité.
