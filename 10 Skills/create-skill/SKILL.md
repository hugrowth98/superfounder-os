...
3. Ce que le skill doit lire avant d'agir : quels fichiers de `01 About-Me/`, `02 Contexte/`, quelle note de dossier.
...
Crée `10 Skills/<nom-du-skill>/SKILL.md` :
...
Une ligne dans `09 Journal/YYYY-MM-DD.md` au format de `/done`, et le skill cité dans la section Cadre de la note du département qui l'utilise.
