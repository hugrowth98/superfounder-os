...
- **qualifier-liste** : jugement fin par correspondance a **votre** ICP (secteur, taille,
  signaux) defini dans `05 Departements/Go-to-Market/contexte.md`. Ideal pour ne garder que ceux qui matchent vraiment
  votre client ideal.
...
> rapport a `05 Departements/Go-to-Market/contexte.md`.
