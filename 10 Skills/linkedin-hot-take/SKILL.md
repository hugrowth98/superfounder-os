...
Voir `05 Departements/Contenu/LinkedIn/strategie-contenu.md`, section Convictions.

> Consulte `05 Departements/Contenu/LinkedIn/strategie-contenu.md`, section Convictions, pour le détail des convictions et les angles de posts associés.
...
Voir `05 Departements/Contenu/LinkedIn/strategie-contenu.md`, section Sujets d'opinion.
...
- **Opinions hors scope** : Rester sur le terrain d'expertise de le créateur (sa niche (voir `05 Departements/Contenu/LinkedIn/strategie-contenu.md`)). Éviter politique, religion, société si ce n'est pas son sujet.
- **Attaquer des personnes** : Toujours critiquer des idées/pratiques, jamais des individus.

## Fichiers de référence

- `references/examples-hot-take.md` - Méta-analyse des facteurs de viralité opinion + emplacement de ton swipe file de posts d'opinion de référence (dans `05 Departements/Contenu/LinkedIn/`).
- `05 Departements/Contenu/LinkedIn/strategie-contenu.md`, section Convictions : les convictions avec angles de posts associés. C'est LA référence pour ancrer chaque hot take dans une conviction authentique.
- Consulte aussi `05 Departements/Contenu/LinkedIn/posts-de-reference.md` pour tes posts d'opinion réels.
