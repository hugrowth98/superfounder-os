# Taxonomie des déclencheurs : 137 raisons d'écrire à quelqu'un

> Lu par le master quand l'utilisateur demande "quels signaux suivre ?" ou "pourquoi écrire à cette personne ?", et par les sous-skills pour élargir leur famille. 4 catégories d'approche, 6 familles de déclencheurs, 137 déclencheurs : 30 entrants, 101 dans le pont, 6 prémisses sortantes. Chaque ligne dit ce que le déclencheur révèle, comment la stack le détecte, quand écrire, combien de points.

## Les 4 catégories d'approche

| Catégorie | Le prospect vous connaît ? | Ce qui déclenche | Message | Personnalisation |
|---|---|---|---|---|
| Entrant | oui, il a levé la main | une demande : démo, devis, essai, chat | 1:many (il est venu à vous) | faible : la relance vient vite, le contexte est le sien |
| Post-contact | oui, mais il n'a rien demandé | il a consommé votre contenu, suivi votre page, ouvert vos emails | 1:many et 1:1 | moyenne : sur le sujet consommé |
| Pont | parfois | une action du prospect ou de son entreprise, sans lien avec votre marketing | 1:many et 1:1 | moyenne à forte : sur le problème que l'action crée |
| Sortant | non | vous l'avez choisi, rien ne s'est passé | 1:1 seulement | forte : recherche, accroche qui sort du lot |

Le post-contact n'a pas de liste propre : ce sont les déclencheurs entrants 12 à 30 quand la personne n'a rien demandé. Même liste, autre message : on ne relance pas une demande, on continue une conversation sur le sujet qu'elle a consommé.

## Lire les colonnes

- **Détection** : le verbe et, entre parenthèses, l'outil de la stack ou l'actor. "À la main" veut dire que la donnée est chez vous (CRM, notes, listes) ou se lit sans outil. "Non listable" veut dire que LinkedIn n'expose pas cette liste : passez par les engageurs des posts, même population.
- **Fenêtre** : depuis la date du déclencheur, voir `fenetres-fraicheur.md`. "Permanent" veut dire que le déclencheur ne se périme pas : il sert de ciblage, pas de timing.
- **Points** : en gras, la valeur du barème (`bareme-signaux.md`). Avec un astérisque, un repère par analogie avec la ligne du barème la plus proche (engagement actif 35, engagement passif 25, abonnement 15, actualité 15). "n/a" : ça se traite à la main et en priorité, pas au score. C'est le cas de toute recommandation et de toute relation en commun : une intro vaut plus que n'importe quel score.

## Famille 1 : entrant (30)

### Contenu et événements

| # | Déclencheur | Ce que ça révèle | Détection | Fenêtre | Points |
|---|---|---|---|---|---|
| 1 | Téléchargement d'un de vos contenus | recherche en cours | à la main (votre site, votre CRM) | j0 à j2 | **35** étude de cas, **10** rapport |
| 2 | Inscrit à votre webinar | intérêt pour le sujet | à la main (votre liste) | avant l'événement | 15* |
| 3 | Participant à votre webinar | intérêt confirmé | à la main (votre liste de présence) | j0 à j2 | **25** |
| 4 | Inscrit à un webinar où vous êtes partenaire | intérêt pour le sujet | liste du partenaire | avant l'événement | 15* |
| 5 | Participant à un webinar où vous êtes partenaire | intérêt confirmé | liste du partenaire | j0 à j2 | 25* |
| 6 | Inscrit à votre événement | intérêt pour le sujet | à la main | avant l'événement | 15* |
| 7 | Participant à votre événement | intérêt confirmé, contact humain | à la main | j0 à j7 | **25** |
| 8 | Inscrit à un événement où vous êtes partenaire | intérêt pour le sujet | liste du partenaire | avant l'événement | 15* |
| 9 | Participant à un événement où vous êtes partenaire | intérêt confirmé | liste du partenaire | j0 à j7 | 25* |

### Intérêt pour le produit

| # | Déclencheur | Ce que ça révèle | Détection | Fenêtre | Points |
|---|---|---|---|---|---|
| 10 | Compte gratuit créé | évaluation en main | à la main (votre produit) | j0 à j7 | **65** |
| 11 | Essai gratuit démarré | évaluation en main, horloge qui tourne | à la main (votre produit) | pendant l'essai | **65** |
| 12 | Abonné à votre blog | notoriété | à la main (votre outil) | permanent | **15** |
| 13 | Abonné à votre newsletter | notoriété | à la main (votre outil d'emailing) | permanent | **15** |
| 14 | Membre de votre communauté | intérêt actif | à la main | permanent | **30** |
| 15 | Membre d'une communauté où vous êtes partenaire | intérêt pour la catégorie | liste du partenaire | permanent | 30* |

### Social et intention

| # | Déclencheur | Ce que ça révèle | Détection | Fenêtre | Points |
|---|---|---|---|---|---|
| 16 | Abonné à votre page ou à votre profil | notoriété | non listable : notifications LinkedIn à la main, ou engageurs | j0 à j2 | **15** |
| 17 | Réaction ou commentaire sur vos posts | engagement | scraper_engagement (Unipile) | j0 à j7 | **25** like, **35** commentaire |
...
| 30 | Message direct au décideur après la vague | ils ont réagi : message 1:1 | envoyer_sequence (LinkedIn) | j0 à j7 après la réaction | selon l'action |

## Famille 2 : pont, par la relation (39)

| # | Déclencheur | Ce que ça révèle | Détection | Fenêtre | Points |
|---|---|---|---|---|---|
| 1 | Même investisseur que vous | porte d'entrée par le fonds | detecter_signal (`signalType: investors`, ou `funding` avec `investor_name`) | permanent | n/a |
| 2 | Même investisseur que vos clients | portefeuille à parcourir | idem | permanent | n/a |
| 3 | Recommandation demandée à vos clients satisfaits | confiance transférée | à la main : vous demandez | permanent | n/a |
| 4 | Recommandation entrante d'un client clé | confiance transférée | à la main | j0 à j2 | n/a |
| 5 | Engagé avec le profil d'un client clé | intérêt pour son sujet, proche du vôtre | scraper_engagement (ses posts) | j0 à j7 | 25* |
| 6 | Engagé avec la page entreprise d'un client clé | idem | scraper_engagement | j0 à j7 | 25* |
...
## Famille 3 : pont, par l'historique (16)

| # | Déclencheur | Ce que ça révèle | Détection | Fenêtre | Points |
|---|---|---|---|---|---|
| 1 | Démo demandée, aucun créneau pris | intention non convertie | HubSpot | même jour, puis j+2 | **100** |
| 2 | Démo acceptée, absent | intention refroidie, pas éteinte | HubSpot | même jour, puis j+2 | 65* |
| 3 | Chat abandonné | question restée sans réponse | votre outil de chat | même jour | 35* |
| 4 | Démo faite, silence depuis | objection non dite | HubSpot | j30 à j60 après | 35* |
| 5 | Parti chez un concurrent, renouvellement qui approche | fenêtre de changement prévisible | HubSpot (date de signature connue) | j90 avant l'échéance | **45** |
| 6 | Perdu sur une objection (budget, timing) | l'objection peut tomber | HubSpot + detecter_signal (`funding`) | quand l'objection tombe | 35* |
| 7 | Trop petit à l'époque, a grandi depuis | entre dans l'ICP | HubSpot + enrichir_entreprise (effectif) | quand le seuil est franchi | 25* |
| 8 | Disqualifié sur un critère qui a changé | entre dans l'ICP | HubSpot + enrichir_entreprise | quand le critère change | 25* |
...
## Famille 4 : pont, en marché (20)

### Fournisseurs adjacents (outils ou services qui se combinent avec le vôtre)

| # | Déclencheur | Ce que ça révèle | Détection | Fenêtre | Points |
|---|---|---|---|---|---|
| 1 | Vient d'adopter un outil adjacent, partenaire | pièce manquante à côté | detecter_techno (relevé mensuel) | j0 à j30 | **35** |
| 2 | Client d'un outil adjacent, non partenaire | même besoin, autre angle | detecter_techno | permanent | 20* |
| 3 | En cycle d'achat chez un fournisseur adjacent | budget en cours d'allocation | à la main (le partenaire vous le dit) | j0 à j30 | **45** |
...
| # | Déclencheur | Ce que ça révèle | Détection | Fenêtre | Points |
|---|---|---|---|---|---|
| 8 | Client parti d'un concurrent, avis négatif laissé | douleur publique et datée | comparateurs lus à la main, puis trouver_personnes | j0 à j60 | **50** |
| 9 | Client parti d'un concurrent après une intégration cassée ou un arrêt de produit | remplacement forcé | annonce d'arrêt lue à la main, puis detecter_techno | j0 à j30 | **45** |
| 10 | Client d'un concurrent, vu sur sa page clients | besoin couvert, renouvellement à venir | à la main (page clients du concurrent, chaque trimestre) | permanent | **20** |
| 11 | Client d'un concurrent, vu par une intégration ou une techno | besoin couvert | detecter_techno | permanent | **20** |
| 12 | En cycle d'évaluation chez un concurrent | fenêtre d'achat ouverte | à la main (bouche à oreille, réseau) | j0 à j30 | **45** |
...
| # | Déclencheur | Ce que ça révèle | Détection | Fenêtre | Points |
|---|---|---|---|---|---|
| 17 | Événement annuel (clôture, budget, rentrée, salon) | besoin qui revient à date fixe | à la main (calendrier) | j-60 à j-30 | 15* |
| 18 | Événement régulier (salon bisannuel, cycle électoral) | besoin lié à l'événement | à la main | j-60 à j-30 | 15* |
| 19 | Besoin saisonnier | pic d'activité prévisible | à la main | avant la saison | 15* |
| 20 | Événement imprévu (crise, réglementation, panne d'un acteur du marché) | besoin soudain | votre veille | j0 à j60 | 15* |

## Famille 5 : pont, par les symptômes (11)
...
Le déclencheur 7 est le plus rentable de cette famille pour une petite structure : les commentateurs des posts d'un influenceur de votre secteur sont des personnes qui parlent de votre sujet, cette semaine, en public.

## Famille 6 : pont, firmographique (15)

| # | Déclencheur | Ce que ça révèle | Détection | Fenêtre | Points |
|---|---|---|---|---|---|
| 1 | Introduction en bourse | transformation, conformité | detecter_signal (`funding`, `round: IPO`) | j30 à j60 | **50** |
| 2 | Levée de fonds | budget frais, objectifs de croissance | detecter_signal (`funding`) | semaines 2 à 8 | **20** à **45** selon le tour |
| 3 | Comptes publiés | chiffres à lire | à la main (registre des sociétés) | j0 à j30 | 15* |
...
| 11 | Nouveau produit | équipe commerciale et marketing en formation | posts de la page entreprise | semaines 1 à 2 | **30** |
...
Ces six approches n'attendent aucun déclencheur : vous choisissez la personne. Elles ferment le compte des 137.

| # | Prémisse | Ce qu'on fait | Verbes |
|---|---|---|---|
| 1 | Descente depuis le dirigeant | on écrit au dirigeant pour qu'il renvoie vers la bonne personne : la recommandation interne vaut une intro | trouver_personnes, trouver_email, envoyer_sequence |
| 2 | Vague "information" vers les utilisateurs | on donne de la valeur aux gens du terrain avant d'approcher le décideur | trouver_personnes, envoyer_sequence |
| 3 | Vague "produit" vers les utilisateurs | on met l'offre dans les mains du terrain (essai, atelier) et l'usage crée la demande | trouver_personnes, envoyer_sequence |
| 4 | Message au décideur après adoption interne | on cite l'usage réel dans son équipe comme preuve | envoyer_sequence (1:1) |
| 5 | Multi-persona | on écrit au décideur économique, à l'évaluateur, à l'utilisateur et au relais, chacun son message, la même semaine | trouver_personnes, envoyer_sequence |
| 6 | Contact à froid classique | recherche, accroche qui sort du lot, 1:1 | trouver_personnes, enrichir_personne, envoyer_sequence |

Message type de la descente depuis le dirigeant :

```
Bonjour {{prenom}},

Je ne sais pas si {{sujet}} arrive sur votre bureau ou sur celui de quelqu'un d'autre. On aide {{icp}} à {{resultat}} : {{preuve_chiffree}}.

À qui vaut-il mieux que j'en parle chez {{entreprise}} ?
```

## Compte

30 entrants + 39 relation + 16 historique + 20 en marché + 11 symptômes + 15 firmographique + 6 sortants = 137.
