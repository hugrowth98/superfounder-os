...
generer une reponse par commentaire (Claude, voix de `05_Departements/Go-to-Market/contexte.md`) -> envoyer avec une
...
Lire `05_Departements/Go-to-Market/contexte.md` (section 5, voix) et rediger une reponse courte, naturelle, specifique au
