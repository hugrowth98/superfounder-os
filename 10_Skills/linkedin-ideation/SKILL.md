...
> Ce skill lit ses sources de veille et la stratégie de contenu dans `05_Departements/Marketing/LinkedIn/strategie-contenu.md` à chaque exécution. Si ce fichier contient encore `[à remplir]`, propose de lancer "Installe mon contenu".
...
Lance 3-5 recherches ciblées sur les piliers de le créateur (voir `les piliers de `05_Departements/Marketing/LinkedIn/strategie-contenu.md`` et `sa niche (voir `05_Departements/Marketing/LinkedIn/strategie-contenu.md`)`). Adapte les requêtes au domaine de l'utilisateur.
...
Organise les idées en un calendrier (la fréquence de publication définie dans `05_Departements/Marketing/LinkedIn/strategie-contenu.md`) respectant :
- **Répartition éditoriale** : voir `la répartition éditoriale de `05_Departements/Marketing/LinkedIn/strategie-contenu.md``
...
Voir `05_Departements/Marketing/LinkedIn/strategie-contenu.md`, section Sources de veille.
...
Consulte `05_Departements/Marketing/LinkedIn/strategie-contenu.md`, section Ressources sauvegardées, pour la liste des guides et ressources bookmarkés par le créateur. Ces ressources sont une mine d'or pour les posts educational et lead-magnet.
...
[Tableau la fréquence de publication définie dans `05_Departements/Marketing/LinkedIn/strategie-contenu.md`]
...
- `05_Departements/Marketing/LinkedIn/strategie-contenu.md` : **LIS EN PREMIER.** Positionnement, monopole personnel, piliers, répartition éditoriale, convictions, sources de veille. C'est le GPS de toute l'idéation.
- `05_Departements/Marketing/LinkedIn/swipe-file.md` : posts qui résonnent avec le créateur, classés par catégorie (4A), et posts des créateurs admirés. Analyse des patterns qui marchent.
- `05_Departements/Marketing/LinkedIn/posts-de-reference.md` : ses posts réels par thème, marqueurs de style, longueurs de référence, sujets à éviter. Pour calibrer les hooks et le ton des idées.
