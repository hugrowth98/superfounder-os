...
- **Liste d'outils** : curation d'outils testés par le créateur
...
Le contenu éducatif générique ne performe plus. N'importe qui peut demander à une IA de produire "5 tips pour [sujet]". Ce qui fait la différence, c'est que le contenu vient de l'expérience vécue de le créateur.
...
Cela se traduit par :
- Des exemples issus de cas réels de le créateur ou de ses clients
...
LISTE → Pour chaque outil :
  ...
  ↳ Prix (si pertinent)
RECOMMANDATION → L'avis de le créateur (lequel il préfère et pourquoi)
...
**Règles** :
- le créateur doit avoir testé ou connaître les outils cités
...
**Règles** :
- Le framework doit être original ou adapté par le créateur
...
- **Trop générique** : "5 tips pour [sujet]" peut être écrit par tout le monde. Ajouter l'angle le créateur.
- **Pas d'expérience derrière** : Si le créateur n'a pas testé/vécu ce dont il parle, ne pas prétendre.
- **Liste plate sans avis** : Une liste d'outils sans recommandation n'apporte rien. Donner un point de vue.
- **Trop technique** : Adapter au niveau de l'audience (son ICP (voir `02_Contexte/Clients-Problems-and-Messages.md`)). Vulgariser sans simplifier à l'excès.
- **Pas de résultat** : Toujours montrer le "et donc ?", le résultat concret de la méthode.

## Fichiers de référence

- `references/examples-educational.md` - Méta-analyse des facteurs de viralité éducative + emplacement de ton swipe file de posts éducatifs de référence (dans `05_Departements/Marketing/LinkedIn/`).
- Consulte aussi `05_Departements/Marketing/LinkedIn/posts-de-reference.md` pour tes posts éducatifs réels.
