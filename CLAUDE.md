...
| `Meeting/` | Les transcripts de calls, dans trois dossiers : `Clients/` (Actuels, Coaching, Anciens-clients, Ateliers), `Events/` (Live, Challenge), `Prospects/`. Ce qui s'y décide ruisselle vers la note du client. | Le compte rendu envoyé (il va chez le client) |
...
|---|---|
| Transcript de call | `Meeting/Clients/` (sous-dossier Actuels, Coaching, Anciens-clients ou Ateliers), `Meeting/Events/` (Live, Challenge) ou `Meeting/Prospects/YYYY-MM/`, règle dans `Meeting/Meeting.md`, puis les décisions ruissellent vers la note du client |
