...
> Lu par Claude Code au démarrage de chaque session, quel que soit le dossier. C'est la carte du workspace : où sont les choses, à quoi sert chaque dossier, comment on crée un document, et quand on lit quoi.
