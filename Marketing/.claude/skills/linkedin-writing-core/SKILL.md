...
> Ce skill ne contient aucune donnée sur le créateur : il lit le contexte à chaque exécution. Avant d'écrire, charge dans l'ordre `About-Me/` (déjà chargé), `Contexte/Tone-and-Voice.md`, `Contexte/Offer-Positioning.md`, `Contexte/Clients-Problems-and-Messages.md`, puis `Marketing/LinkedIn/ressources/strategie-contenu.md` et `posts-de-reference.md`. Si l'un d'eux contient encore `[à remplir]`, propose de lancer "Installe mon contenu".

## Qui est le créateur

Voir `Contexte/Offer-Positioning.md` et `Marketing/LinkedIn/ressources/strategie-contenu.md`, section Positionnement.

**Monopole personnel** : voir `Marketing/LinkedIn/ressources/strategie-contenu.md`

**Posture LinkedIn** : voir `Marketing/LinkedIn/ressources/strategie-contenu.md`

**ICP (clients)** : voir `Contexte/Clients-Problems-and-Messages.md`
**IAP (audience large)** : voir `Marketing/LinkedIn/ressources/strategie-contenu.md`, section Audiences
...
### Marqueurs de style
Voir `Contexte/Tone-and-Voice.md`, section Marqueurs de style, et `Marketing/LinkedIn/ressources/posts-de-reference.md`.
...
### Répartition éditoriale (la fréquence de publication définie dans `Marketing/LinkedIn/ressources/strategie-contenu.md`)
Voir `Marketing/LinkedIn/ressources/strategie-contenu.md`, section Répartition éditoriale.

### Authority-First Framework (le mix autorité / perso / offre de `Marketing/LinkedIn/ressources/strategie-contenu.md`)
...
La répartition exacte est définie par `le mix autorité / perso / offre de `Marketing/LinkedIn/ressources/strategie-contenu.md``.

### Piliers thématiques
Voir `Marketing/LinkedIn/ressources/strategie-contenu.md`, section Piliers.
...
- `Marketing/LinkedIn/ressources/swipe-file.md` : posts des créateurs admirés et posts likés. Pour s'inspirer des structures et styles qui performent.
- `Marketing/LinkedIn/ressources/posts-de-reference.md` : les posts réels du créateur analysés. C'est LA référence pour calibrer la voix et le ton. À consulter en priorité.
