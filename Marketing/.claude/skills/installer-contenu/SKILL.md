...
description: >
  ...
  l'utilisateur les trois fichiers de Marketing/LinkedIn/ressources/ (strategie-contenu.md,
...
Tu installes la machine de contenu pour l'utilisateur. Il vient d'ouvrir `Marketing/`
...
|---|---|---|
| Offre, différenciation, preuves | `Contexte/Offer-Positioning.md` | le second cerveau |
| Clients, problèmes, mots exacts | `Contexte/Clients-Problems-and-Messages.md` | le second cerveau |
| Voix, marqueurs de style, ce qu'il ne dit jamais | `Contexte/Tone-and-Voice.md` | le second cerveau (ou ce skill si vide) |
| Piliers, répartition, convictions, sources, créateurs admirés | `Marketing/LinkedIn/ressources/strategie-contenu.md` | ce skill |
| Ses meilleurs posts | `Marketing/LinkedIn/ressources/posts-de-reference.md` | ce skill |
| Posts des autres qui l'inspirent | `Marketing/LinkedIn/ressources/swipe-file.md` | ce skill, puis au fil de l'eau |
...
À partir des posts :
1. Range-les par type dans `Marketing/LinkedIn/ressources/posts-de-reference.md` (Educational,
...
Remplis `Marketing/LinkedIn/ressources/strategie-contenu.md` section par section. Déduis un
