...
Voir `Marketing/LinkedIn/ressources/strategie-contenu.md`, section Créateurs admirés.

Mais ces patterns sont des outils, pas des moules. La voix reste celle de le créateur : les marqueurs de ton de `Contexte/Tone-and-Voice.md`
...
- `Marketing/LinkedIn/ressources/swipe-file.md` -> les posts des créateurs admirés et tes posts likés
- `Marketing/LinkedIn/ressources/posts-de-reference.md` -> tes propres posts, pour caler la voix
...
- **Respecter l'adresse au lecteur** habituelle de le créateur (voir `les marqueurs de style de `Contexte/Tone-and-Voice.md``).
...
- Utiliser des mots que le créateur n'utiliserait pas (voir `ce qu'il ne fait jamais (voir `Contexte/Tone-and-Voice.md` et `About-Me/anti-ai-voice.md`)` et le voice-guide)
