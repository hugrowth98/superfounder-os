...
5. **Clients-Problems-and-Messages.md** (section 5.5), le plus stratégique. Demander en priorité : transcripts d'appels de vente, verbatim clients. S'il en a, les déposer dans `Meeting/`.
...
C'est la note que Claude lira avant tout travail pour ce client. Un transcript de call avec lui va dans `Meeting/`, et `/done` fait ruisseler ce qui s'y décide vers cette note.
