...
1. **Installez votre second cerveau d'abord** ("Installe mon second cerveau" a la racine du workspace).
   La prospection lit votre offre, votre cible et votre voix dans `02 Contexte/` : elle ne vous
   les redemande pas.
2. **Ouvrez le dossier `05 Departements/Vente/`** dans Claude Code. Verifiez que vous avez un
...
- Lire votre second cerveau (`02 Contexte/`) et ne vous poser que les questions propres a la
...
Declenche `qualifier-liste`. Garde ce qui matche votre cible (definie dans `02 Contexte/`),
