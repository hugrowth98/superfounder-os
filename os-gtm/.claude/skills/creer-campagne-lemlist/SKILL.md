...
positionnement dans `contexte.md` (sections 1, 3, 4, 6) pour ecrire un email generique de
premier contact.

### Etape 2 - Creer la campagne

Utiliser l'outil MCP Lemlist de creation de campagne avec sequence (nom de campagne clair,
ex: `OS-GTM - [cible] - [date]`), en fournissant le contenu du premier email (objet + corps).
