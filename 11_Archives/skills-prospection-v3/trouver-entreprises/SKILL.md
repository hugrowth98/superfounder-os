...
Lire la section 2 (ICP) de `05_Departements/Go-to-Market/contexte.md` : secteur, taille d'entreprise, zone geographique.
Si l'utilisateur donne une cible dans sa phrase ("des PME SaaS en France"), l'utiliser en
priorite ; sinon se rabattre sur `05_Departements/Go-to-Market/contexte.md`.
...
python3 .claude/skills/trouver-entreprises/scripts/client.py search \
  ...
  --location "France" \
  --limit 50 \
  --out "Listes-prospection/entreprises.csv"
```
