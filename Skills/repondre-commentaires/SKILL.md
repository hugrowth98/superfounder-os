...
generer une reponse par commentaire (Claude, voix de `Vente/contexte.md`) -> envoyer avec une
...
Lire `Vente/contexte.md` (section 5, voix) et rediger une reponse courte, naturelle, specifique au
