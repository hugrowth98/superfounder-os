...
1. Lit `Vente/contexte.md` a la racine du projet (section 2 "Votre client ideal (ICP)" et section 8
...
- Ne jamais inventer des criteres qui ne sont pas dans `Vente/contexte.md`. Si `Vente/contexte.md` n'est
...
Relire `Vente/contexte.md`. Si les sections 2 et 8 sont encore au format template (crochets non
